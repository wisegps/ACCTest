...
package com.example.streaming.rtcp;
...
public class SenderReport {
	...
	private int mLocalPort = 5000 +  2 * COUNT + 1;
	...
	public SenderReport() {
		...
		try {
			Log.d("SenderReport", "mLocalPort is " + mLocalPort);
			usock = new MulticastSocket(mLocalPort);
			COUNT++;
			if ( COUNT > 1) {
				COUNT = 0;
			}
